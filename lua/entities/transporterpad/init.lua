...
ENT.WireDebugName = "Transporter Pad"

function ENT:SpawnFunction(ply, tr)
	local ent = ents.Create("transporterpad")
...
function ENT:Initialize()
	...
	util.PrecacheModel("models/props_phx/construct/metal_angle360.mdl")
	util.PrecacheSound("voyager_transporter")
	util.PrecacheSound("voyager_transporter_2")
	...
	self.JumpCoords = {}
	self.Inputs = WireLib.CreateSpecialInputs(self.Entity,{"Beam to pads","Beam from pads","Beam to vector","Energise pad","Keep formation","Target1","TargetLocation","Target Pad"},{[6] = "ENTITY",[7] = "VECTOR",[8] = "ENTITY"}); 
	self.Outputs = WireLib.CreateSpecialOutputs(self.Entity,{"Energising","Pad1"})
end
